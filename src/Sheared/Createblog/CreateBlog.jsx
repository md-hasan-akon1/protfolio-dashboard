      ...
      <div className=" mt-20 border rounded-lg bg-white border-gray-400 shadow-md shadow-primary">
        <div className="p-4">
          <div className="flex justify-between">
            ...
            <Link to={"/all-blogs"}>
              {" "}
              <button className="btn btn-outline hover:bg-primary hover:text-white text-slate-500 mb-2">
                View All Blogs
              </button>
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className=" md:flex md:gap-14 w-full">
              <div>
                <label className="text-1xl font-semibold text-slate-500 ">
                  {" "}
                  News Title
                </label>
                <input
            ...
            <textarea
              ...
              placeholder="Type Here News Details "
              className="textarea border border-black textarea-lg md:w-5/6 "
            ></textarea>
            <br />
            {errors.details && (
              <span className="text-red-600">this field is required</span>
            ...
            <input
              disabled={loading}
              className="py-2 px-4 rounded-lg  text-white hover:bg-sky-600 hover:text-black bg-primary md:w-5/6 "
              type="submit"
            />
          </form>
        </div>
